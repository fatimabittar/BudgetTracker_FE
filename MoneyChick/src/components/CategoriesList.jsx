    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={{ flex: 1 }}>
        {categories.map((category) => {
          const disableDelete = category.categoryHasBudget || category.categoryHasTransaction;

          return <View key={category._id} style={styles.categoryContainer}>
            <TouchableOpacity onPress={() => deleteCategory(category._id)} disabled={disableDelete} style={[styles.iconContainer, disableDelete && styles.disabled]}>
